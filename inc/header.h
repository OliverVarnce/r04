...
bool mx_char_validator(char c);
void mx_error_checker(char *filename, char *x1, char *y1, char *x2, char *y2, int argc);
void mx_printintmass(int *num, int len, int hight);
void math(int *num, char *mass, t_coor *coor, int len, int hight );
